...
import { DemoStation } from "@/components/evaluacion/demo/DemoStation";
      ...
      <div className="min-h-screen bg-slate-50">
        <header className="border-b-4 border-gold bg-navy py-6 text-white">
          <div className="mx-auto flex max-w-4xl items-center gap-3 px-6">
            ...
            <h1 className="font-serif text-lg font-bold">Estación de Demostración EDDOE</h1>
        ...
        <main className="mx-auto max-w-4xl px-6 py-10">
          <DemoStation sessionId={assessmentSession.id} />
        </main>
      </div>
    );
  }
